          ...
          <BorderBox hoverable key={idx + 1} mt="30px">
            <Box h="full" bg="#020615">
              <Box h="full" px="15px" py="15px" bg="#020615">
                <Flex h="280px" gap="32px" alignItems="center">
                  <Image
                    h="284px"
                    w="284px"
                  ...
                  <Box>
                    <Flex gap="10px" alignItems="center">
                      ...
                      <Text fontSize="20px" lineHeight="32px" fontWeight={600}>
                        {product?.name}
                      </Text>
                    </Flex>
                    <Text mt="15px" fontSize="16px" lineHeight="25px" fontWeight={400} mb="45px">
                      {product?.description}
                    </Text>
